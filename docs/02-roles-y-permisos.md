...
- **Asignar docente/experto** a una solicitud (`nueva` → tiene que hacerlo antes/al avanzar): elige entre profesor de planta (lista cerrada, `ICESI_FACULTY`) o registra un consultor externo (ficha completa: nombre obligatorio, identificación, firma consultora, correo, teléfono, perfil). **Solo editable mientras la solicitud está en "Nueva" o "En Experto"** — una vez pasa a "En Costeo" o "Entregada" queda bloqueado (el resto del proceso, costeo y coordinación con el cliente, ya asumió ese docente). Todo cambio, en cualquier momento en que fue posible hacerlo, queda registrado en un historial visible (quién, cuándo, de cuál a cuál) — a diferencia del costeo, que abre una ronda de negociación por cambio, antes un cambio de docente no dejaba ningún rastro. ⚠️ El bloqueo es una decisión de Tomás tras encontrar el hueco probando en vivo (2026-09-25), no confirmada aún por Dianis — ver `08`, pregunta 17: falta decidir si además de auditar, el bloqueo total es lo que ella espera, o si prefiere permitir el cambio con motivo obligatorio en vez de prohibirlo.
