...
import { Calendar, User, Tag, ArrowUpRight } from "@/components/icons";
...
export function RequestCard({ req }: { req: RequestItem }) {
  ...
  return (
    <Link
      ...
      className="group block rounded-xl border border-border dark:border-[#252838] bg-card dark:bg-[#141622] p-3.5 shadow-xs transition-all hover:border-[#5454e9]/50 hover:shadow-md dark:hover:bg-[#171926]"
    >
